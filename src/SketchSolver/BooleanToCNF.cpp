...
public:
    ...
    set<int> pos; //positive/matching tupleIds
    set<int> neg; //negative/non-matching tupleIds
	...
	virtual bool synthesis() {
		conflict.clear();
        //Iterate over all possible simFn's 
	...
	virtual void print(ostream& out) {
		out << "( " << theta << "< IN_0" << ")";
                //Is this just for passing result to FE? Can this be an uninterp fun call?

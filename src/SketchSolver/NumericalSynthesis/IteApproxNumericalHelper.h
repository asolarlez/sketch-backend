...
class IteApproxNumericalHelper: public NumericalSolverHelper {
	set<int> boolNodes;
...
public:
	IteApproxNumericalHelper(FloatManager& _fm, BooleanDAG* _dag, map<int, int>& _imap);
	~IteApproxNumericalHelper(void);

...
public:
	enum SATSolverResult{
	 ...
	 virtual void addChoiceClause(int x, int a, int b, int c, int gid=0)=0;
	 virtual void addXorClause(int x, int a, int b, int gid=0)=0;
	 virtual void addOrClause(int x, int a, int b, int gid=0)=0;
	 virtual void addBigOrClause(int* a, int size, int gid=0)=0;
	 virtual void addAndClause(int x, int a, int b, int gid=0)=0;
	 virtual void addEqualsClause(int x, int a, int gid=0)=0;
	 virtual void addEquateClause(int x, int a, int gid=0)=0;
	 virtual void setVarClause(int x, int gid=0)=0;
     virtual void assertVarClause(int x, int gid=0)=0;

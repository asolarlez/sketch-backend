...
static inline int         Abc_LatchInit( Abc_Obj_t * pLatch )        { assert(Abc_ObjIsLatch(pLatch)); return (long)pLatch->pData;          }
...
/*=== abcSat.c ==========================================================*/
extern int                Abc_NtkMiterSat( Abc_Ntk_t * pNtk, int nConfLimit, int nInsLimit, int fJFront, int fVerbose, int * pNumConfs, int * pNumInspects );
